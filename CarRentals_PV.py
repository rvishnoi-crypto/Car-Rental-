...
def changeScale(self):
    ...
    fullnameLab.config(text=fullname)
...
fullnameLabel= Label(mainframe, text="Full Name", font=("Courier", 10))
...
transFrame= LabelFrame(secondframe, text=" Transmission")
transVar= IntVar()
transVar.set(1)
...
# fullname Lab
fullnameLab= Label(Sumframe, text=" ")
...
fullnameEntry.grid(row=2, column=2, columnspan=3, sticky= W, pady=10)

ageLabel.grid(row=3, column=1, sticky=W)
ageEntry.grid(row=3, column=2, sticky=W, pady=10)

pickLabel.grid(row=4, column=1, sticky= W)
pickupOm.grid(row=4, column=2, sticky=W+E)

PdateLabel.grid(row=5, column=1, sticky=W)
month1Scale.grid(row=5, column=2,sticky=E+W)
day1Scale.grid(row=6, column=2, sticky=W+E)

returnLabel.grid(row=7, column=1, sticky=W)
month2Scale.grid(row=7, column=2,sticky=E+W)
day2Scale.grid(row=8, column=2, sticky=W+E)
...
carframe.grid(row=3, column=1, sticky=W+E,  pady=70)
...
transFrame.grid(row=3, column=2, sticky=W+E, padx=70)
Manrb.grid(row=1, sticky=W)
Autorb.grid(row=2, sticky=W)
# How many Passengers Label, Label Frame and RadioButtons
##passLabel.grid(row=4, column=1, sticky=W, pady=10)
passFrame.grid(row=4, column=1, sticky=W+E)
tworb.grid(row=1, sticky=W)
fourrb.grid(row=2, sticky=W)
morerb.grid(row=3, sticky=W)

# Budget
budgetLabel.grid(row=5, column=1, sticky=S+N,rowspan=2)
budgeScale.grid(row=6, column=2, sticky=E+N)
#Search Button
...
matchFrame.grid(row=4, column=1, sticky=N+W, rowspan=3)
...
extraLabel.grid(row=5, column=1, sticky= W)
...
memLab.grid(row=7, column=1,sticky=W)
...
fullnameLab.grid(row=5, sticky=W)
